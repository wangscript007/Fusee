...
namespace Fusee.Engine.Imp.Graphics.WebAsm
{
    ...
    {
        internal WebGLContext _gl;
        internal FusCanvas _canvas;

        /// <summary>
        /// Initializes a new instance of the <see cref="RenderCanvasImp"/> class.
        /// </summary>
        public RenderCanvasImp(FusCanvas canvas, /* TODO: remove rest of parameters */ WebGLContext gl, int width, int height)
        {
            _canvas = canvas;
            _gl = gl;
            Width = width;
        ...
        /// <summary>
        /// Gets and sets a value indicating whether full screen is enabled.
        /// </summary>
        /// <remarks> Currently not implemented.</remarks>
