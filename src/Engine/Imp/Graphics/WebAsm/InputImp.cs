...
//            .InvokeVoidAsync("onkeydown", new Action<>(evt => OnCanvasKeyDown((int)evt.GetObjectProperty("keyCode"))));
//            _canvas.JSRuntime.InvokeVoidAsync("onkeyup", new Action(evt => OnCanvasKeyUp((int)evt.GetObjectProperty("keyCode"))));
